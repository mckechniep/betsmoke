...
// HOME PAGE (Dashboard)
// ============================================
// Shows Premier League standings with option to
// view Overall, Home, or Away tables.
// ============================================
...
const Home = () => {
  ...
  // ============================================
  // FETCH PREMIER LEAGUE SEASONS ON MOUNT
  // ============================================
  useEffect(() => {
    const fetchSeasons = async () => {
      try {
        const data = await dataApi.getSeasonsByLeague(PREMIER_LEAGUE_ID);
        ...
        setError('Failed to load Premier League seasons');
      } finally {
  ...
  const renderTableRow = (row, index) => {
    ...
    return (
      <tr 
        ...
        className={`
          hover:bg-gray-50 
          ${tableView === 'overall' && index < 4 ? 'border-l-4 border-l-blue-500' : ''} 
          ${tableView === 'overall' && index >= 17 ? 'border-l-4 border-l-red-500' : ''}
        `}
      >
        {/* Position */}
  ...
  return (
    <div className="space-y-8">
      ...
      {/* ============================================ */}
      {/* PREMIER LEAGUE STANDINGS SECTION */}
      {/* ============================================ */}
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="px-4 py-4 bg-gradient-to-r from-purple-700 to-purple-900 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            {/* Premier League "Logo" placeholder */}
            <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
              <span className="text-purple-700 font-bold text-sm">PL</span>
            </div>
            <div>
        ...
        {/* Table Legend (Only for Overall view) */}
